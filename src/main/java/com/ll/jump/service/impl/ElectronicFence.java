...
import com.ll.jump.model.Point;
...
public class ElectronicFence {
    public static void main(String[] args) {
        initPolygon();
        boolean result = isPtInPoly(122.580299,37.394091,polygon.get(0));
        System.out.println("result:" + result);
    }

    private static List<Point[]>  polygon = new ArrayList<Point[]>();
...
//            });
    ...
    public static boolean isPtInPoly ( double ALat , double ALon ,Point[] ps) {
